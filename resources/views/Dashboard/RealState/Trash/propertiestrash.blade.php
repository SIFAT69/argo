                              ...
                              <tbody>
                                @foreach ($projects as $project)
                                  <tr>
                                      ...
                                      <td>
                                        <a href="#" class="btn btn-outline-primary rounded bs-tooltip" data-placement="top" title="Retore" data-toggle="modal" data-target="#restore{{ $loop->index }}"><i class="fas fa-trash-restore"></i></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                  ...
                                                  <a href="{!! route('HardDeleteProperty', $project->id) !!}" type="button" class="btn btn-danger">Sure, Delete</a>
                                              </div>
                                          {{-- </div> --}}
                                      </div>
                                  </div>
                                  ...
                                  <div class="modal fade" id="restore{{ $loop->index }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                  <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                  <a href="{!! route('restoreProperties', $project->id) !!}" type="button" class="btn btn-primary">Yes, Restore</a>
                                              </div>
                                          {{-- </div> --}}
                                      </div>
                                  </div>
