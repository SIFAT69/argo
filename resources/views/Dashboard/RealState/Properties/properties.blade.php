                              ...
                              <tbody>
                                @foreach ($properties as $property)
                                  <tr>
                                      <td>{{ $loop->index+1 }}</td>
                                      <td>
                                        <img src="../uploads/{{ $property->youtube_thumb }}" alt="" width="120px">
                                      </td>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  <h5 class="modal-title" id="exampleModalCenterTitle">Do you want to delete "{{ $property->title }}" ?</h5>
                                              ...
                                              <div class="modal-footer">
                                                  ...
                                                  <a href="{!! route('softDeleteProperties', $property->id) !!}" type="button" class="btn btn-danger">Sure, Delete</a>
                                              </div>
                                          {{-- </div> --}}
                                      </div>
                                  </div>
