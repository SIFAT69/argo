                              ...
                              @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="{!! route('categoryDelete',$category->id) !!}" class="btn btn-outline-danger rounded bs-tooltip" data-placement="top" title="Delete"><img src="https://img.icons8.com/material-rounded/24/000000/delete-sign.png"/></a>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <input type="hidden" name="id" value="{{ $category->id }}">
                                                <input type="text" value="{{ $category->title }}" placeholder="Enter your category name...." class="form-control mb-3" name="title">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{!! route('categoryPost') !!}" method="post">
              @csrf
            <div class="modal-body">
                <input type="text" placeholder="Enter your category name...." class="form-control mb-3" name="title">
                <select class="form-control mb-3" name="status">
