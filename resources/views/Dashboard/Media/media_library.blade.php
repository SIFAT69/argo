              ...
              <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                @include('Alerts.danger')
                  <div class="widget-content widget-content-area br-6">
                    <h4 href="#" class="float-left" style="margin: 1rem">All Media</h4>
                                ...
                                @foreach ($medias as $media)
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{!! route('LibraryFilesDelete',$media->id) !!}" class="btn btn-outline-danger rounded bs-tooltip" data-placement="top" title="Delete"><img src="https://img.icons8.com/material-rounded/24/000000/delete-sign.png"/></a>
                                      </td>
                                  </tr>
                                  {{-- Edit Modals --}}
                                      ...
                                      <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                  ...
                                                  <a href="{!! route('LibraryFilesDelete',$media->id) !!}" class="btn btn-danger">Delete</a>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
