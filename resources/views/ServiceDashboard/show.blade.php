                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addExpense">Add new expenses</a>
                                        @endif
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="addExpense">Add an expense</h5>
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#delete{{ $expense->id }}" class="btn btn-outline-danger"> <i class="fas fa-trash-alt"></i> </a>
                                                        </td>
                                                    </tr>
