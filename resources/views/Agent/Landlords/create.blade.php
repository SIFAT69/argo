                          ...
                          <div class="my_dashboard_review mb40">
                              <div class="col-lg-12">
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    <form class="" action="{!! route('Landlord.store') !!}" method="post">
                                      @csrf
                                      ...
                                      <textarea name="address" class="form-control mb-3"cols="3" rows="3"></textarea>
                                      <label for="">Contact Number:</label>
                                      <input type="tel" required class="form-control mb-3" name="contact_number">
                                      <label for="">Email:</label>
                                      <input type="email" required class="form-control mb-3" name="email">
                                      <label for="">Bank Name:</label>
                                      <input type="text" required class="form-control mb-3" name="bank_name">
                                      <label for="">Bank Account:</label>
                                      <input type="text" required class="form-control mb-3" name="bank_account">
                                      <label for="">Bank Sort Code:</label>
                                      <input type="text" required class="form-control mb-3" name="bank_sort_code">
