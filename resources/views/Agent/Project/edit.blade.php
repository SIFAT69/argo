                              ...
                              <div class="col-md-12">
                                  <div class="">
                                      <div class="widget-content">
                                        <textarea name="description" class="form-control" rows="30">{{ $project->description }}</textarea>
                                        <script>
                              ...
                              <div class="col-md-6 mb-4">
                                  ...
                                  <select class="form-control" name="facility[]">
                                    ...
                                    @foreach ($variable =json_decode($project->facilities) as $faci)
                                      <option @if($faci == $facility->facilities) selected @endif value="{{ $faci }}">{{ $faci }}</option>
                                    @endforeach
                                  </select>
                              </div>
                              <div class="col-md-6 mb-4">
