                            ...
                            <div class="feat_property list favorite_page style2">
                              ...
                              <div class="details">
                                <div class="tc_content">
                                  ...
                                  <p><span class="flaticon-placeholder"></span> {{ $project->city }} {{ $project->states }} {{ $project->location }}</p>
                                  <a class="fp_price text-thm" href="#">${{ $project->price }}</a>
                                </div>
                              </div>
                            </div>
                            </th>
                            <td>{{ Carbon\Carbon::parse($project->created_at)->format('Y-M-d') }}</td>
                            <td><span class="status_tag badge">{{ $project->moderation_status }}</span></td>
                            {{-- <td>2,345</td> --}}
                            <td>
                              <ul class="view_edit_delete_list mb0">
                                <li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Edit"><a href="{!! route('MyPropertiesEdit',$project->id) !!}"><span class="flaticon-edit"></span></a></li>
                                <li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Delete"><a href="{!! route('HardDeleteProperty', $project->id) !!}"><span class="flaticon-garbage"></span></a></li>
                              </ul>
                            </td>
                          </tr>
                        @empty
