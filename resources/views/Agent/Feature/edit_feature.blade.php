                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-xl-4 mb10">
                          <div class="breadcrumb_content style2 mb30-991">
                              <h2 class="breadcrumb_title">My Features</h2>
                          ...
                          <div class="my_dashboard_review mb40">
                              <div class="col-lg-12">
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    <form class="" action="{!! route('agentsFeaturesUpdate', $feature->id) !!}" method="post">
                                      @csrf
                                      <label for="">Enter your feature name:</label>
                                      <input type="hidden" name="added_by" value="{{ Auth::id() }}">
                                      <input type="text" required class="form-control mb-3" name="feature" value="{{ $feature->feature }}">
