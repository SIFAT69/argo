                              ...
                              <ul class="mb0">
                                  <li class="list-inline-item">
                                      <div class="candidate_revew_search_box course fn-520">
                                          <a class="btn btn-danger text-white mb-2" href="{!! route('agentsFeaturesList') !!}">Go Back</a>
                                      </div>
                                  </li>
                              </ul>
                          </div>
                          ...
                          <div class="my_dashboard_review mb40">
                              <div class="col-lg-12">
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    <form class="" action="{!! route('agentsFeaturesPost') !!}" method="post">
                                      @csrf
                                      <label for="">Enter your feature name:</label>
                                      <input type="hidden" name="added_by" value="{{ Auth::id() }}">
                                      <input type="text" required class="form-control mb-3" name="feature">
