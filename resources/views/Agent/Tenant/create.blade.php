                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-xl-6">
                                                <div class="my_profile_setting_input form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="formGroupExampleInput1" name="name" value="{{ $name }}" required>
                                                    @error('name')
                                                        @include('layouts.atom.error')
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6">
                                                <div class="my_profile_setting_input form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="formGroupExampleEmail" name="email" value="{{ $email }}" required>
                                                    @error('email')
                                                        @include('layouts.atom.error')
                                                    @enderror
                                                </div>
